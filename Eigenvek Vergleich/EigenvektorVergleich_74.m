function [ELEMENT_eigenvectors, element_eigenvec_interp, MAC_matrix] = EigenvektorVergleich_74(file_ELEMENT_prefix, num_ELEMENT_files, file_element_prefix, num_element_files, file_element_nodes_coordinate)
%% 特征向量插值处理后对比(粗网格数据7列，细网格数据4列)
%% 粗网格特征向量处理
% 粗网格特征向量文件前缀和文件数量
